...
int main(int argc, char** argv)
{
  ...
  {
    Eigen::Affine3d pose;
    pose = Eigen::Translation3d(0.0, 0.0, 0.3 + 0.05 * i);
  ...
  {
    Eigen::Affine3d pose;
    pose = Eigen::Translation3d(0.0, 0.04 * i, 0.35);
    descartes_core::TrajectoryPtPtr pt = makeTolerancedCartesianPoint(pose);
    points.push_back(pt);
  }
  ...
  const std::string group_name = "jakaUr";
...
// 子函数
//TrajectoryPtPtr 是 descartes_core::TrajectoryPt的智能指针的别称
